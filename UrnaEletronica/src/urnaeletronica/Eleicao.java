...
//Métodos relacionados à cargos
     ...
     public final Cargos addCargo(int ID, String nome){
         Cargos tmp = new Cargos(ID, nome);
         this.cargos.add(tmp);
         return tmp;
     }
     
    public final Cargos getCargoByID(int ID){
...
//Métodos relacionados à partidos
     //Adiciona Partido
     public final Partidos addPartido(int ID, String nome){
         Partidos tmp = new Partidos(ID,nome);
         this.partidos.add(tmp);
         return tmp;
     }
     
     public final Partidos getPartidoByID(int ID){
...
//Métodos relacionados ao candidato
     ...
     public final void addCandidato(int ID, String nome, Cargos cargo, Partidos partido){
         this.candidatos.add(new Candidatos(ID, nome, cargo, partido));
     }
     
     public final Candidatos getCandidatoByID(int ID){
     ...
     //Lista candidatos
     public final void listaCandidatos(){
        int i;
